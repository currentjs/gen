...
| HTTP error handling              | router, gen | gen: 0.5.5 router: 0.2 | M    | Add errors to router, use in generator                                          |
| Support of tailwind in tpls      | gen         | 0.5.6                  | M    | setting in app.yaml                                                             |
| Database migrations              | gen         | 0.5.7                  | L    |                                                                                 |
