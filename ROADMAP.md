...
| Configurable identifier types     | gen         | 0.5.5                  | M    | Support int/uuid/string in app config                                           |
| HTTP error handling               | router, gen | gen: 0.5.6 router: 0.2 | M    | Add errors to router, use in generator                                          |
| Support of tailwind in tpls       | gen         | 0.5.7                  | M    | setting in app.yaml                                                             |
| Database migrations               | gen         | 0.5.8                  | L    |                                                                                 |
